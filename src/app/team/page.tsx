...
export const metadata: Metadata = {
  title: "Team",
  description:
    "Connexxion Group — Meet our executive board, functional directors, and management team building tomorrow today.",
};
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            The people building <span className="text-grad">tomorrow today.</span>
          </>
        }
