...
export const subsidiaries: Subsidiary[] = [
  ...
  },
  {
    ...
    name: "Ocean & Waves",
    sector: "Energy",
    tagline: "Clean hydro power generation harnessing the force of water.",
    description:
      "Hydro power generation company producing clean, renewable electricity from water resources.",
    long: "Ocean & Waves is a hydro power generation company that harnesses the natural force of water to produce clean, reliable, and renewable electricity. Committed to sustainable energy solutions, the company develops and operates hydro power assets that contribute to energy security and support the group's broader vision of driving Africa's green energy transition.",
    highlights: [
  ...
  {
    slug: "dharul-hijrah-fertilizer",
    name: "Dharul Hijrah Fertilizer Company Limited",
    sector: "Agriculture",
    ...
    long: "Dharul Hijrah Fertilizer Company Limited supplies farmers with a full range of organic and inorganic fertilizers formulated for soil health and crop yield. Beyond inputs, the company produces and distributes farm outputs — connecting production to market and closing the loop across the agricultural value chain.",
    highlights: [
